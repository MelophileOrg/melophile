...
.loading .bar {
  ...
  animation: loading calc(var(--speed) * 1s) ease-in-out calc(var(--delay) * var(--speed) * 1s / -4) infinite;
}
...
.slide-up {
  --slidedelay: 0;
  animation: slide-up .5s ease-out calc(var(--slidedelay) * .1s), hide calc(var(--slidedelay) * .1s);
}
