...
export default VResponsive.extend({
  ...
  methods: {
    ...
    genContent() {
      return this.computedAspectRatio != null ? VResponsive.options.methods.genContent.call(this) : undefined;
    },
  ...
  render(h) {
    ...
    node.children = [this.__cachedImage, this.__genPlaceholder(), this.genContent()];
