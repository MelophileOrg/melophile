  ...
  export default {
    ...
    data: () => ({
      ...
      tabs: [
        ...
        {type: 'subheader', title: 'Charts'},
        {type: 'link', title: 'Top Played', img: 'chart', path: '/library/charts/played'},
        {type: 'link', title: 'Top Saved', img: 'chart', path: '/library/charts/saved'},
        {type: 'link', title: 'Extremes', img: 'chart', path: '/library/charts/extremes'},
